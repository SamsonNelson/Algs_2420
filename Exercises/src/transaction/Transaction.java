...
public class Transaction implements Comparable<Transaction> {
	 ...
	 */
	private static String demoReadingUserInput() {
		StdOut.print("Reading user name: ");
		String who = StdIn.readString();
		StdOut.print("Please enter date: ");
		String when = StdIn.readString();
		StdOut.print("Please enter amount: ");
    ...
    public static void main(String[] args) {
    	...
    	StdOut.print("How many transactions do you want to do: ");
    	int response = StdIn.readInt();
    	Transaction[] a = new Transaction[response];
    	
    	for (int i = 0; i < response; i++) {
			a[i] = new Transaction(demoReadingUserInput());
		}
